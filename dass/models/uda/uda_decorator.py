...
class UDADecorator(BaseSegmentor):
    def __init__(self, **cfg):
        ...
        self.cfg = Config(cfg)
        self.model = build_segmentor(deepcopy(self.cfg.model))
        self.train_cfg = self.cfg.model.train_cfg
        self.test_cfg = self.cfg.model.test_cfg
        self.num_classes = self.cfg.model.decode_head.num_classes
